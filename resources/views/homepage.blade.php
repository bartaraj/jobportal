...
@section('content')
    ...
    <div class="input-form">
        <input type="text" name="keyword" placeholder="Job Title or keyword" value="{{ request('keyword') }}">
    </div>
    <div class="input-form">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="{{ route('job_details.show', $job->id) }}"><img src="{{ asset($job->company->logo) }}" alt="" height="50" width="50"></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="{{ route('job_details.show', $job->id) }}"><h4> {{$job->title}}</h4></a>
                                    <ul>
                            ...
                            <div class="items-link f-right">
                                <a href="{{ route('job_details.show', $job->id) }}">{{$job->jobType->name}}</a>
